...
public class BeforeRegionPage {
    ...
    public BeforeRegionPage(Stage primaryStage, Player p1) {
        ...
        String[] region1items = {"Fuel<placeholder.png>", "Weaponry<placeholder.png>", "Seeds<placeholder.png>", "farmitem4<placeholder.png>", "farmitem5<placeholder.png>", "farmitem6<placeholder.png>"};
        ...
        String[] region3items = {"Justin Bieber: My World 2.0<placeholder.png>", "boyband2<placeholder.png>", "Fuel<placeholder.png>", "boyband4<placeholder.png>", "boyband5<placeholder.png>", "fuel<placeholder.png>"};
        ...
        String[] region4items = {"Rod & Reel<placeholder.png>", "Fuel<placeholder.png>", "scandi3<placeholder.png>", "scandi4<placeholder.png>", "scandi5<placeholder.png>", "scandi6<placeholder.png>"};
        ...
        String[] region5items = {"Air Conditioning<placeholder.png>", "Ice<placeholder.png>", "Fuel<placeholder.png>", "arctic4<placeholder.png>", "arctic5<placeholder.png>", "arctic6<placeholder.png>"};
        ...
        String[] region6items = {"Croissants<placeholder.png>", "Fuel<placeholder.png>", "desert3<placeholder.png>", "desert4<placeholder.png>", "desert5<placeholder.png>", "fuel<placeholder.png>"};
        ...
        String[] region7items = {"glitch1<placeholder.png>", "GPS<placeholder.png>", "glitch3<placeholder.png>", "glitch4<placeholder.png>", "glitch5<placeholder.png>", "glitch6<placeholder.png>"};
        ...
        String[] region8items = {"Sword<placeholder.png>", "med2<placeholder.png>", "Bow and Arrow<placeholder.png>", "med4<placeholder.png>", "med5<placeholder.png>", "med6<placeholder.png>"};
        ...
        String[] region9items = {"Bison Burger<placeholder.png>", "wild2<placeholder.png>", "wild3<placeholder.png>", "Fuel<placeholder.png>", "wild5<placeholder.png>", "fuel<placeholder.png>"};
        ...
        String[] region10items = {"Disco Pant<placeholder.png>", "disco2<placeholder.png>", "disco3<placeholder.png>", "disco4<placeholder.png>", "disco5<placeholder.png>", "disco6<placeholder.png>"};
