...
public class BeforeRegionPage {
    ...
    public BeforeRegionPage(Stage primaryStage, Player p1) {
        ...
        String[] farmItems = {"Fuel<fuel.png>", "Weaponry<ax.png>", "Seeds<seed.png>", "Corn<corn.png>", "Milk<milk.png>", "Shovel<shovel.png>"};
        ...
        String[] safariItems = {"Capuchin\nMonkey<monkey.png>", "Fuel<fuel.png>", "Diamond<diamond.png>", "Meat<meat.png>", "Binoculars<bino.png>", "Safari Hat<hat.png>"};
        ...
        String[] boyBandItems = {"Justin Bieber:\nMy World 2.0<jb.png>", "Gold Chain<chain.png>", "Fuel<fuel.png>", "Ripped Denim<rippedjeans.png>", "Jonas Brothers\nAlbum<year3000.png>"};
        ...
        String[] scandinavianItems = {"Rod & Reel<r&r.png>", "Fuel<fuel.png>", "Knife<knife.png>", "Hiking Pack<pack.png>", "Fish<fish.png>"};
        ...
        String[] arcticItems = {"Air\nConditioning<ac.png>", "Ice<ice.png>", "Fuel<fuel.png>", "Ax<ax.png>", "Fur Coat<fur.png>"};
        ...
        String[] desertItems = {"Cactus<cactus.png>", "Fuel<fuel.png>", "Sand<sand.png>", "Sunscreen<sunscreen.png>", "Water<water.png>"};
        ...
        String[] wildWestItems = {"Bison Burger<burger.png>", "Ax<ax.png>", "Fuel<fuel.png>", "Lasso<lasso.png>", "Revolver<revolver.png>"};
        ...
        String[] discoItems = {"Disco Pant<discopant.png>", "Fuel<fuel.png>", "Disco Ball<discoball.png>", "Gogo Boots<boots.png>", "X-ray\nSunglasses <sunglasses.png>"};
