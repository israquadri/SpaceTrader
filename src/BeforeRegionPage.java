...
public class BeforeRegionPage {
    ...
    public BeforeRegionPage(Stage primaryStage, Player p1) {
        ...
        String[] boyBandItems = {"Justin Bieber: My World 2.0<jb.png>", "Gold Chain<chain.png>", "Fuel<fuel.png>", "Ripped Denim<rippedjeans.png>", "Jonas Brothers Album<year3000.png>"};
